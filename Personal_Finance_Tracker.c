...
void about_us() {
    ...
    printf("\n\nThis project has been created by Anik Bhattacharjee And Md. Jilalish Saif Khan.\n\n");

    printf("Our details\n");

    printf("\nName:Anik Bhattacharjee.\nID:CE22053\n");

    printf("\n\nName:Md. Jilalish Saif Khan.\nID:CE22051\n");

    printf("\nIt is a Self Finance Tracker System Project for our 2nd year 1st Semester based on C programming language.\n\n");
    printf("\-------------------------------------------------------------------------------------------------------------------\n");
}
...
int main() {
    ...
    do {
        ...
        printf("9. Update Transaction\n");
        printf("10.Delete Transaction\n");
        printf("11.Delete All Data\n");
        printf("12.About Us\n");
        printf("13.Exit\n");
        ...
        switch (choice) {
            ...
            case 9: update_transaction(); break;
            case 10: delete_transaction(); break;
            case 11: delete_all_data(); break;
            case 12:about_us();break;
            case 13:
                save_data();
